...
class RedNoteMMProcessor(BaseMMProcessor):
...
def init_mm_processor(*args, **kwargs):
    ...
    has_src = True
    try:
        import src.tuner.data.mm_plugin as mm_plugin  # noqa
    except BaseException:
        has_src = False

    if has_src or Configs.RL_USE_NATIVE_PROCESSOR:
        return RedNoteMMProcessor(*args, **kwargs)
