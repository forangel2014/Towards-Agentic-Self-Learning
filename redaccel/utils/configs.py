...
class _Configs:
    ...
    LOG_FILE = EnvProperty("LOG_FILE", str, "./log/python/redaccel.log")
    LOG_COLOR = EnvProperty("LOG_COLOR", bool, True)
    LOG_FORMAT = EnvProperty(
        "LOG_FORMAT",
        str,
        "<blue>RedAccel{extra[rank_desc]}</blue>|"
    ...
    REDACCEL_ENABLE_IMAGE_CLEAR = EnvProperty("REDACCEL_ENABLE_IMAGE_CLEAR", bool, True)

    IMG_DL_PREFIX = "redaccel_imgs__"
