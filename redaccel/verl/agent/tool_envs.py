...
class ToolBase(metaclass=ToolMeta):
    ...
    def __init__(self, name: str, description: str = "", parameters: Optional[dict] = None, **kwargs):
        """Code adapted from: https://github.com/0russwest0/Agent-
        R1/blob/main/agent_r1/tool/tool_base.py Initialize the tool.
    ...
    @classmethod
    def create(cls, name, description="", parameters=None, **kwargs):
        """Usage example:
